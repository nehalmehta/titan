...
public class AccumuloConnectorFactory extends
		BasePooledObjectFactory<AccumuloConnector> {
	String[] args;
	 ...
	 */
	@Override
	public PooledObject<AccumuloConnector> wrap(
	 ...
	 */
	/*
	 * @Override public void passivateObject(PooledObject<StringBuffer>
	 * pooledObject) { pooledObject.getObject().setLength(0); }
	 */
